...
export const practices = [
  ...
  },
  {
    ...
    category: 'Yoga & mindful',
    duration: 60,
    image: asset('class-gentle.jpg'),
    imagePosition: '50% 40%',
    note: 'Slow, steady & grounded',
    description: 'A slower-paced, mindful flow focused on strength, control and stability. Poses are held a little longer, with intentional transitions, deep stretches and steady breath — strong without the rush.',
    bestFor: 'Strength without rushing, or a grounded flow',
  },
  {
    name: 'Yin Yoga',
    category: 'Yoga & mindful',
