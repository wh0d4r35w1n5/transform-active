...
function Membership({ onBook }: { onBook: (intent: BookingIntent) => void }) {
  ...
  return (
    <section id="membership" className="section pricing-section">
      <div className="container">
        <SectionHeading eyebrow="Membership" title={<>Simple, <em>Honest</em> Pricing</>}>Debited weekly in Australian dollars. Ongoing plans have no lock-in — just 30 days&apos; written notice.</SectionHeading>
